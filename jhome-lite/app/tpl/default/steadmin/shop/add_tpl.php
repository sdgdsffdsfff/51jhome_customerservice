...
$Document = array(
    'pageid' => 'shop-add', //页面标示
    'pagename' => '添加店铺', //当前页面名称
          ...
          <div class="panel-body">
            <form class="form-horizontal" method="post" id="form1">
              <div class="form-group">
                ...
                <div class="col-sm-3">
                  <input type="text" name="shop_name" id="shop_name" placeholder="" class="form-control" value="" />
                  <span class="help-block"></span></div>
              </div>
              <div class="form-group">
                <label class="col-sm-1 control-label">分店名称</label>
                <div class="col-sm-3">
                  <input type="text" name="shop_alt_name" id="shop_alt_name" placeholder="" class="form-control" value="" />
                  <span class="help-block">品牌及连锁店的分店名称，没有则不填</span></div>
              </div>
              <div class="form-group">
                <label class="col-sm-1 control-label">店铺LOGO</label>
                <div class="col-sm-3">
                  <input type="text" name="pic_url" id="pic_url" placeholder="" class="form-control" value="" />
                ...
                <div class="col-sm-3">
                  <select class="day form-control" style="width:auto;" name="area_id" id="area_id">
                    <?php
						foreach($area as $val){
					?>
                    <option value="<?php echo $val['aid'];?>"><?php echo $val['name'];?></option>
					<?php }?>
                    </select>
              </div>
              </div>
              <div class="form-group">
                ...
                <div class="col-sm-3">
                  <select class="day form-control" style="width:auto;" name="service_id" id="service_id">
					...
					?>
                    <option value="<?php echo $val['sid'];?>"><?php echo $val['stitle'];?></option>
					<?php }?>
                    </select>
              </div>
              </div>
                  ...
                  <div class="row">
                    ...
                    <div class="col-xs-1 radio m-l-large select_no_result_type">
                      <label class="radio-custom">
                        <input type="radio" name="shop_type" value="<?php echo $key;?>" <?php if (!$key){echo 'checked';}?>/>
                  ...
                  <div class="row">
                    ...
                    <div class="col-xs-1 radio m-l-large select_no_result_type">
                      <label class="checkbox-custom">
                        <input type="checkbox" name="tips_list[]" value="<?php echo $key;?>" <?php if (!$key){echo 'checked';}?>/>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-3">
                  <input type="text" name="tel" id="tel" placeholder="0571-85888888" class="form-control" value="" />
                  <span class="help-block"></span></div>
              </div>
              <div class="form-group">
                <label class="col-sm-1 control-label">人均消费</label>
                <div class="col-sm-1">
                  <input type="text" style="width:80px" name="avg_price" id="avg_price" placeholder="" class="form-control" value="" />
                  <span class="help-block"></span></div>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-1">
                  <input type="text" style="width:80px" name="score_total" id="score_total" placeholder="" class="form-control" value="" />
                  <span class="help-block">满分：10.0</span></div>
              </div>
              <div class="form-group">
                <label class="col-sm-1 control-label">口味评分</label>
                <div class="col-sm-1">
                  <input type="text" style="width:80px" name="score_flavour" id="score_flavour" placeholder="" class="form-control" value="" />
                  <span class="help-block">满分：10.0</span></div>
              </div>
              <div class="form-group">
                <label class="col-sm-1 control-label">服务评分</label>
                <div class="col-sm-1">
                  <input type="text" style="width:80px" name="score_service" id="score_service" placeholder="" class="form-control" value="" />
                  <span class="help-block">满分：10.0</span></div>
              </div>
              <div class="form-group">
                <label class="col-sm-1 control-label">准点率</label>
                <div class="col-sm-1">
                  <input type="text" style="width:80px" name="ontime_point" id="ontime_point" placeholder="填整数" class="form-control" value="" />
                  <span class="help-block"></span></div>
              </div>
              <div class="form-group">
                <label class="col-sm-1 control-label">营业时间</label>
                <div class="col-sm-3">
                  <input style="width:180px" type="text" name="stime" id="stime" placeholder="" class="form-control" value="09:00" />
                  <span class="help-block"></span></div>
              </div>
              <div class="form-group">
                <label class="col-sm-1 control-label">打烊时间</label>
                <div class="col-sm-3">
                  <input style="width:180px" type="text" name="etime" id="etime" placeholder="" class="form-control" value="21:00" />
                  <span class="help-block"></span></div>
              </div>
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  <div class="row">
                    ...
                    <div class="col-xs-1 radio m-l-large select_no_result_type">
                      <label class="radio-custom">
                        <input type="radio" name="is_delay" value="<?php echo $key;?>" <?php if (!$key){echo 'checked';}?>/>
                        <i class="fa fa-circle-o <?php if (!$key){echo 'checked';};?>"></i><?php echo $val;?></label>
                    </div>
                    <?php
						}
              ...
              <div class="form-group">
                ...
                <div class="col-sm-6">
                  <textarea class="form-control" id="content" name="content"  style="height:80px"></textarea>
                  <span class="help-block"></span></div>
              </div>
              <div class="form-group">
                <label class="col-sm-1 control-label">经纬度</label>
                <div class="col-sm-2">
                  <input type="text" name="lng" id="lng" placeholder="经度坐标..." class="form-control" value="" />
                </div>
                <div class="col-sm-2">
                  <input type="text" name="lat" id="lat" placeholder="纬度坐标..." class="form-control" value="" />
                </div>
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
				...
				var centerInfo={"city":"杭州","lat":30.271855,"lng":120.163254};
                var init = function() {
...
$(function(){
	...
	$('#form1').submit(function(){
		...
		Msg.loading();
		  $.post('<?php echo U('shop/post');?>',$(this).serialize(),function(result){
			  Msg.hide();
			  resetSubmit("#sub-ok",'保存');
			  if (result.status==1){
