...
(function($) {
    ...
    $.extend($.facebox, {
        settings: {
            ...
            resize: false, //缩放居中
            overlay: true,
            loadingImage: PUBLIC_URL + 'images/content/loading.gif',
            closeImage: PUBLIC_URL + 'images/content/closelabel.gif',
          ...
          <tbody> \
            ...
            <tr> \
              ...
              <td class="body"><div class="toper"> \
                  <a href="#" class="close"> \
                    <img src="' + PUBLIC_URL + 'images/content/closelabel.gif" title="关闭" class="close_image" /> \
                  </a> \
    ...
    function init(settings) {
        ...
        if ($.facebox.settings.fixed) {//保持居中
            $(window).scroll(function() {
                $.facebox.fixed();
            });
        }
        if ($.facebox.settings.resize) {//缩放
