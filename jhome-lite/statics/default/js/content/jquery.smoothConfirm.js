...
+   '<span class = "bg"></span>'
+   '<div class = "content">'
+       '<div class="dialog-close-bar"><div class="dialog-close" title="关闭"></div></div><div class="dialog-inner"></div>'
+       '<div class="smooth-btns">'
+           '<a class="smooth-button green ok" href="javascript:void(0);"><span></span></a>'
+           '<a class="smooth-button normal cancel" href="javascript:void(0);"><span></span></a>'
+       '</div>'
+   '</div>'
+'</div>';
